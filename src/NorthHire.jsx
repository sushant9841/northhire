...
import { Ctx, use } from "./store/context.js";
...
import { EmpMark, SaveBtn, HiringTypeBadge, JobCard, BlogCard, TrainingCard } from "./pages/shared/cards.jsx";
...
import { CvPreview, CvsPage, CvEditPage } from "./pages/seeker/cv.jsx";
...
import { LocationInput, InlineList, QuestionBuilder, aiSuggestJD } from "./pages/shared/formControls.jsx";
import {
...
import { IP, I } from "./design/icons.jsx";
import {
  MARKS, MarkSvg, SKIN, HAIR, TOP, PortraitSvg, SCENES, SceneSvg, SCENE_URLS, sceneUrl,
  EMPLOYER_LOGOS, empLogoUrl, portraitUrl, SmartImg, Mark, Portrait, Scene, PHOTOS,
  scenePhotoUrl, SmartScene, SmartLogo, PORTRAIT_SEEDS, SmartPortrait,
  Btn, Tag, Card, inp, Input, Area, Sel, Field, Switch, CheckRow, Bar, Ring, Empty, Banner,
  H1, H2, Lbl, Stat, Modal, Tabs, DatePicker, MAXW, PADX, Page, RichText,
} from "./design/primitives.jsx";
import { useMedia } from "./helpers/hooks.js";
import {
  uid, money, pay, payUnit, payShort, annual, dlText,
  _ago, _fmtDate, _weekAgo, _dayAgo, _dayFromNow, _weekStart, nowStamp,
} from "./helpers/utils.js";
import { CATS, CATM, PROVS, PCODE, STAGES, CV_TEMPLATES, PLANS, PLAN_REQUIRES, PLAN_ORDER } from "./store/seed/constants.js";
import { SEED_EMPLOYERS } from "./store/seed/employers.js";
import { SEED_JOBS } from "./store/seed/jobs.js";
import { SEED_BLOGS } from "./store/seed/blogs.js";
import { SEED_TRAININGS } from "./store/seed/trainings.js";
import { SEED_PEOPLE } from "./store/seed/people.js";
import { SEED_APPS } from "./store/seed/applications.js";
import { HR_DEPARTMENTS, HR_DEPARTMENTS_SEED } from "./store/seed/hrDepartments.js";
import { HR_EXPENSES_SEED } from "./store/seed/hrExpenses.js";
import { HR_EMPLOYEE, HR_EMPLOYEES } from "./store/seed/hrEmployees.js";
import { HR_ATTENDANCE } from "./store/seed/hrAttendance.js";
import { HR_LEAVE_REQUESTS } from "./store/seed/hrLeave.js";
import { HR_TASKS } from "./store/seed/hrTasks.js";
import { HR_EVENTS } from "./store/seed/hrEvents.js";
import { HR_INVOICES } from "./store/seed/hrInvoices.js";
import { HR_CHATS, HR_CHAT_MESSAGES } from "./store/seed/hrChats.js";
import { HR_PAYRUNS } from "./store/seed/hrPayruns.js";
...
import {
  ...
  AGENCY_PERM_JOB_IDS, AGENCY_LISTED_JOB_IDS, SEED_AGENCY_LICENSE, AGENCY_MODULES,
} from "./store/seed/agency.js";
...
/* ═══════════════════════════════════════════════════════════════════════════
   HR SUITE — Seed data for the Enterprise HR platform.
   Every HR employee record links to a public NorthHire profile via `email`.
   The `visibility` object controls what appears on the public side.
   ═══════════════════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════════════════
   HR STORE — helpers that plug into the main NorthHire store (A18).
   Kept in a separate function so it can be composed cleanly.
   These are hooks-based and are called from within the main NorthHire component.
   ═══════════════════════════════════════════════════════════════════════════ */


/* ═══════════════════════════════════════════════════════════════════════════
   STAFFING AGENCY — Data model + seeded state
   ═══════════════════════════════════════════════════════════════════════════ */

/* ─── Per-province employer burden rates for staffing markup calc ─── */


/* ═══════════════════════════════════════════════════════════════════════════
   WORKER VIEW — For seekers who opted in
   CLIENT STAFFING TAB — For employers with active assignments
   HIRING TYPE BADGE — Shown on every job touchpoint
   ═══════════════════════════════════════════════════════════════════════════ */
