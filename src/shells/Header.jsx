...
export function Header(){
  ...
  <div className={`h-full max-w-site mx-auto flex items-center gap-3.5 ${mob?"px-3.5":"px-6"}`}>
    {showBackMob ? <>
      <button onClick={A.back} aria-label={t("nav.back")} className="bg-bg border-0 w-11 h-11 rounded-xl cursor-pointer flex items-center justify-center text-text shrink-0 transition duration-150 active:scale-95"><I n="chevL" s={19} w={2.2}/></button>
